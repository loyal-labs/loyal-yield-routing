pub use loyal_actions::{
    ...
    SUBSCRIPTIONS_CREATE_RECURRING_DELEGATION, SUBSCRIPTIONS_INIT_AUTHORITY,
    SUBSCRIPTIONS_PROGRAM_ID, SUBSCRIPTIONS_REVOKE_DELEGATION, SUBSCRIPTIONS_TRANSFER_RECURRING,
