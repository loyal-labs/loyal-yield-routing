...
const MIGRATIONS: &[Migration] = &[
    Migration {
        ...
        sql: include_str!("../../../loyal-yield-store/migrations/0001_loyal_yield_orchestration.sql"),
        expected_checksum: None,
    },
    Migration {
        version: 2,
        name: "balance_sweep_surplus_lots",
        sql: include_str!("../../../loyal-yield-store/migrations/0002_balance_sweep_surplus_lots.sql"),
        expected_checksum: None,
    },
    Migration {
        version: 3,
        name: "balance_sweep_initial_surplus",
        sql: include_str!("../../../loyal-yield-store/migrations/0003_balance_sweep_initial_surplus.sql"),
        expected_checksum: None,
    },
    Migration {
        version: 4,
        name: "managed_vault_setup_policy",
        sql: include_str!("../../../loyal-yield-store/migrations/0004_managed_vault_setup_policy.sql"),
        expected_checksum: None,
    },
    Migration {
        version: 5,
        name: "add_unsupported_amount_semantics",
        sql: include_str!("../../../loyal-yield-store/migrations/0005_add_unsupported_amount_semantics.sql"),
        expected_checksum: None,
    },
    Migration {
        version: 6,
        name: "generic_balance_sweep_token_accounts",
        sql: include_str!("../../../loyal-yield-store/migrations/0006_generic_balance_sweep_token_accounts.sql"),
        expected_checksum: None,
    },
    Migration {
        version: 7,
        name: "balance_sweep_scheduled_slots",
        sql: include_str!("../../../loyal-yield-store/migrations/0007_balance_sweep_scheduled_slots.sql"),
        expected_checksum: None,
    },
    Migration {
        version: 8,
        name: "route_lookup_tables",
        sql: include_str!("../../../loyal-yield-store/migrations/0008_route_lookup_tables.sql"),
        expected_checksum: Some("d20151ef6d6076961195da6c6cf3b4e11bb3e2045f729bdf4b118f6c7d3ddc34"),
    },
    Migration {
        version: 9,
        name: "idle_vault_routing",
        sql: include_str!("../../../loyal-yield-store/migrations/0009_idle_vault_routing.sql"),
        expected_checksum: None,
    },
    Migration {
        version: 10,
        name: "realtime_events",
        sql: include_str!("../../../loyal-yield-store/migrations/0010_realtime_events.sql"),
        expected_checksum: None,
    },
    Migration {
        version: 11,
        name: "autodeposit_realtime_events",
        sql: include_str!("../../../loyal-yield-store/migrations/0011_autodeposit_realtime_events.sql"),
        expected_checksum: None,
    },
    Migration {
        version: 12,
        name: "idle_vault_decision_plan_guardrails",
        sql: include_str!("../../../loyal-yield-store/migrations/0012_idle_vault_decision_plan_guardrails.sql"),
        expected_checksum: None,
    },
    Migration {
        version: 13,
        name: "earn_realtime_events",
        sql: include_str!("../../../loyal-yield-store/migrations/0013_earn_realtime_events.sql"),
        expected_checksum: None,
    },
    Migration {
        version: 14,
        name: "autodeposit_execution_slot_realtime",
        sql: include_str!("../../../loyal-yield-store/migrations/0014_autodeposit_execution_slot_realtime.sql"),
        expected_checksum: None,
    },
    Migration {
        version: 15,
        name: "realtime_web_mobile_protocol",
        sql: include_str!("../../../loyal-yield-store/migrations/0015_realtime_web_mobile_protocol.sql"),
        expected_checksum: None,
    },
    Migration {
        version: 16,
        name: "autodeposit_requested_slot_wakeup",
        sql: include_str!("../../../loyal-yield-store/migrations/0016_autodeposit_requested_slot_wakeup.sql"),
        expected_checksum: None,
    },
    Migration {
        version: 17,
        name: "reusable_route_lookup_tables",
        sql: include_str!("../../../loyal-yield-store/migrations/0017_reusable_route_lookup_tables.sql"),
        expected_checksum: None,
    },
    Migration {
        version: 18,
        name: "earn_activity_realtime",
        sql: include_str!("../../../loyal-yield-store/migrations/0018_earn_activity_realtime.sql"),
        expected_checksum: None,
    },
    Migration {
        version: 19,
        name: "legacy_lookup_table_imports",
        sql: include_str!("../../../loyal-yield-store/migrations/0019_legacy_lookup_table_imports.sql"),
        expected_checksum: None,
    },
    Migration {
        version: 20,
        name: "demand_driven_shared_market_catalog",
        sql: include_str!("../../../loyal-yield-store/migrations/0020_demand_driven_shared_market_catalog.sql"),
        expected_checksum: None,
    },
    Migration {
        version: 21,
        name: "reusable_alt_production_controls",
        sql: include_str!("../../../loyal-yield-store/migrations/0021_reusable_alt_production_controls.sql"),
        expected_checksum: None,
    },
    Migration {
        version: 22,
        name: "shared_market_alt_bundles",
        sql: include_str!("../../../loyal-yield-store/migrations/0022_shared_market_alt_bundles.sql"),
        expected_checksum: None,
    },
    Migration {
        version: 23,
        name: "value_priority_rebalance_queue",
        sql: include_str!("../../../loyal-yield-store/migrations/0023_value_priority_rebalance_queue.sql"),
        expected_checksum: None,
    },
    Migration {
        version: 24,
        name: "fleet_route_confirmer",
        sql: include_str!("../../../loyal-yield-store/migrations/0024_fleet_route_confirmer.sql"),
        expected_checksum: None,
    },
    Migration {
        version: 25,
        name: "fee_only_route_payer_shards",
        sql: include_str!("../../../loyal-yield-store/migrations/0025_fee_only_route_payer_shards.sql"),
        expected_checksum: None,
    },
    Migration {
        version: 26,
        name: "target_capacity_reservations",
        sql: include_str!("../../../loyal-yield-store/migrations/0026_target_capacity_reservations.sql"),
        expected_checksum: None,
    },
    Migration {
        version: 27,
        name: "rebalance_opportunity_attempt_generations",
        sql: include_str!("../../../loyal-yield-store/migrations/0027_rebalance_opportunity_attempt_generations.sql"),
        expected_checksum: None,
    },
    Migration {
        version: 28,
        name: "reusable_alt_terminal_repair",
        sql: include_str!("../../../loyal-yield-store/migrations/0028_reusable_alt_terminal_repair.sql"),
        expected_checksum: None,
    },
    Migration {
        version: 29,
        name: "fleet_commit_lifetime_fences",
        sql: include_str!("../../../loyal-yield-store/migrations/0029_fleet_commit_lifetime_fences.sql"),
        expected_checksum: None,
    },
    Migration {
        version: 30,
        name: "fused_queue_accrual_binding",
        sql: include_str!("../../../loyal-yield-store/migrations/0030_fused_queue_accrual_binding.sql"),
        expected_checksum: None,
    },
    Migration {
        version: 31,
        name: "fleet_commit_lifetime_fence_errcode",
        sql: include_str!("../../../loyal-yield-store/migrations/0031_fleet_commit_lifetime_fence_errcode.sql"),
        expected_checksum: None,
    },
    Migration {
        version: 32,
    ...
    Migration {
        ...
        sql: include_str!("../../../loyal-yield-store/migrations/0058_autoswap_confirmed_reconciliation.sql"),
        expected_checksum: None,
    },
    Migration {
        version: 59,
        name: "autodeposit_single_target_state",
        sql: include_str!("../../../loyal-yield-store/migrations/0059_autodeposit_single_target_state.sql"),
        expected_checksum: None,
    },
    Migration {
        version: 60,
        name: "rebalance_confirmation_target_state",
        sql: include_str!("../../../loyal-yield-store/migrations/0060_rebalance_confirmation_target_state.sql"),
        expected_checksum: None,
    },
    Migration {
        version: 61,
    ...
    Migration {
        ...
        sql: include_str!("../../../loyal-yield-store/migrations/0067_earn_max_three_policy_v2.sql"),
        expected_checksum: None,
    },
    Migration {
        version: 68,
    ...
    Migration {
        version: 81,
        name: "backyard_rwa_finalized_report_failure",
        sql: include_str!("../../../loyal-yield-store/migrations/0081_backyard_rwa_finalized_report_failure.sql"),
        expected_checksum: None,
    },
];
