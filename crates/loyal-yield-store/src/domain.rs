...
/// Tracks a Kamino vault whose allocation is controlled outside the fleet
/// optimizer and remains pinned to Kamino's main market.
pub const FIXED_KAMINO_MAIN_ROUTE_MODE: &str = "fixed_kamino_main";
