...
pub const CONFIG_MAGIC: &[u8; 8] = b"LHUBCFG3";
pub const MAX_ALLOWED_MINTS: usize = 8;
pub const HUB_CONFIG_SPACE: usize = 8 + 32 + 32 + 32 + 2 + 1 + 1 + 1 + (MAX_ALLOWED_MINTS * 32);
pub const MAX_REBALANCE_TRANSFERS: usize = 16;
...
pub const REBALANCE_INVENTORY: u8 = 5;
