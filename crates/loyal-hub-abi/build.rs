...
struct Schema {
    ...
    magic: BTreeMap<String, String>,
    limits: BTreeMap<String, usize>,
    instructions: BTreeMap<String, u8>,
    accounts: BTreeMap<String, BTreeMap<String, u8>>,
...
fn generate(schema: &Schema) -> String {
    ...
    for (instruction, record_name) in &schema.instruction_records {
