...
pub const JUPITER_SWAP_DISCRIMINATOR: [u8; 8] = [229, 23, 203, 151, 122, 227, 173, 42];
pub const JUPITER_LEGACY_SWAP_SLIPPAGE_BPS_OFFSET: u64 = 24;
pub const JUPITER_DEFAULT_MAX_SLIPPAGE_BPS: u16 = 100;
pub const LOYAL_HUB_SWAP_PROGRAM_ID: Pubkey =
    pubkey!("3qbR1eZRqXUWroWKKYhbDmR3FfqTHfqSU8zZSxtANzYh");
