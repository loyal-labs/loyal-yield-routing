...
export const JUPITER_SHARED_ACCOUNTS_ROUTE_V2_DISCRIMINATOR = [209, 152, 83, 147, 124, 254, 216, 233] as const;
...
export const TREASURY_JUPITER_SWAP_ACTION_SEED = 3n;
export const TREASURY_TOP_UP_ACTION_SEED = 4n;
