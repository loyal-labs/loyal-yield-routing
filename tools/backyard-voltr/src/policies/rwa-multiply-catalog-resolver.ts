...
function decodedReserveBoundary(
  ...
  const observed = {
    ...
    liquidityDecimals: reserve.liquidity.mintDecimals.toString(),
    ...
    farmCollateral: String(reserve.farmCollateral),
    farmDebt: String(reserve.farmDebt),
    refreshOracles: {
      pyth: String(reserve.config.tokenInfo.pythConfiguration.price),
      switchboardPrice: String(reserve.config.tokenInfo.switchboardConfiguration.priceAggregator),
      switchboardTwap: String(reserve.config.tokenInfo.switchboardConfiguration.twapAggregator),
      scope: String(reserve.config.tokenInfo.scopeConfiguration.priceFeed),
      scopePriceChain: reserve.config.tokenInfo.scopeConfiguration.priceChain,
      scopeTwapChain: reserve.config.tokenInfo.scopeConfiguration.twapChain,
    },
