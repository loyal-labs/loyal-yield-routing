...
**Release remains FAIL / not activated.** The new exit requires a pinned-program execution proof and current-release full lifecycle verification. Complete move-cost production, live selector orchestration, initializer policy installation, historical PYUSD return, controlled journal/pilot activation, user access deployment and live deposit/rotation/withdrawal verification remain required. No production balance, database or deployment changed in this correction.
