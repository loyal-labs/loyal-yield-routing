...
alt:
  ...
  usageLeasesRejectedDuringMutation, mutatingOperationsLeasedDuringUsage,
  verifyOperationsLeasedDuringUsage, usageFenceBroadcastCommits,
  usageFenceBroadcastRejections,
